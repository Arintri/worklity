...
const COPY = {
  en: {
    ...
    subtitle: "Use this vaccine due date calculator to estimate scheduled vaccination due dates from a child's date of birth using the vaccination schedule in India. It is for planning and reference only; actual vaccination decisions should follow healthcare-provider and public-health guidance.",
    eyebrow: "India vaccination planning tool", childName: "Child Name", optional: "Optional",
    overviewTitle: "Baby and child vaccination schedule stages covered",
    overviewText: "This baby vaccination schedule uses the child's date of birth to estimate the configured routine due dates from birth through 16 years: birth; 6, 10 and 14 weeks; 9–11 and 16–24 months; 5–6 years; 10 years; and 16 years.",
    ...
    about: "About this schedule", aboutText: "Vaccination due dates are estimated from the child's date of birth using the India schedule configured in this calculator. Official age ranges are shown as full due windows.",
  ...
  bn: {
    ...
    subtitle: "শিশুর জন্মতারিখ থেকে ভারতে ব্যবহৃত টিকাদান সময়সূচি অনুযায়ী নির্ধারিত টিকার সম্ভাব্য তারিখ দেখতে এই ক্যালকুলেটর ব্যবহার করুন। এটি শুধু পরিকল্পনা ও তথ্যের জন্য; টিকা দেওয়ার সিদ্ধান্তে স্বাস্থ্যকর্মী ও জনস্বাস্থ্য নির্দেশনা অনুসরণ করুন।", eyebrow: "ভারতের টিকাদান পরিকল্পনা টুল",
    childName: "শিশুর নাম", optional: "ঐচ্ছিক", namePlaceholder: "শিশুর নাম লিখুন", dob: "জন্মতারিখ",
    overviewTitle: "শিশুর টিকাদান সময়সূচির ধাপগুলো",
    overviewText: "এই শিশুর টিকাদান সময়সূচিতে জন্মতারিখের ভিত্তিতে ১৬ বছর পর্যন্ত কনফিগার করা নিয়মিত টিকার সম্ভাব্য সময় হিসাব করা হয়: জন্ম; ৬, ১০ ও ১৪ সপ্তাহ; ৯–১১ ও ১৬–২৪ মাস; ৫–৬ বছর; ১০ বছর; এবং ১৬ বছর।",
    ...
    about: "এই সময়সূচি সম্পর্কে", aboutText: "এই ক্যালকুলেটরে কনফিগার করা ভারতীয় সময়সূচি অনুযায়ী শিশুর জন্মতারিখ থেকে টিকার সম্ভাব্য নির্ধারিত তারিখ হিসাব করা হয়। সরকারি বয়সসীমা থাকলে পুরো সময়সীমা দেখানো হয়।",
