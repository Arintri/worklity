          ...
          <div className="messageRegion" role="status" aria-live="polite" aria-atomic="true">
            ...
            {result && (
              <div className="resultsPanel">
                ...
                {beyondFortyTwoWeeks && (
                  <p className="durationNotice">
                    {bn
                      ? "এই হিসাব ৪২ সপ্তাহের বেশি দেখাচ্ছে। শেষ মাসিকের তারিখটি আবার যাচাই করুন এবং একজন যোগ্য মাতৃসেবা চিকিৎসক বা স্বাস্থ্যকর্মীর সঙ্গে কথা বলুন।"
                      : "This estimate is beyond 42 weeks. Verify the LMP date and speak with a qualified maternity-care professional."}
                  </p>
                )}
